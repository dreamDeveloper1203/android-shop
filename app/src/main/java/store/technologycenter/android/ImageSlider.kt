...
import store.technologycenter.android.adapters.ViewPagerAdapter
...
import store.technologycenter.android.layouts.TechCenterViewPager
...
class ImageSlider @JvmOverloads constructor(
    ...
    private var viewPager: TechCenterViewPager? = null
    ...
    init {
        ...
        placeholder =
                typedArray.getResourceId(R.styleable.ImageSlider_placeholder, R.drawable.tech_center_logo)
        errorImage =
                typedArray.getResourceId(R.styleable.ImageSlider_error_image, R.drawable.tech_center_logo)
